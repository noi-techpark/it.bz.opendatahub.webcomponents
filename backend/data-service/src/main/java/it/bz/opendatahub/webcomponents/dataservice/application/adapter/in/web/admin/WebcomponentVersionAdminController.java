...
public class WebcomponentVersionAdminController {
	...
	private final WebcomponentVersionWebConverter webcomponentVersionWebConverter;

	public WebcomponentVersionAdminController(CreateWebcomponentVersionUseCase createWebcomponentVersionUseCase, ReplaceWebcomponentVersionUseCase replaceWebcomponentVersionUseCase, DeleteWebcomponentVersionUseCase deleteWebcomponentVersionUseCase, WebcomponentVersionWebConverter webcomponentVersionWebConverter) {
	...
	@PostMapping
	public WebcomponentVersionRest createNewVersion(@PathVariable String uuid, @RequestBody @Valid CreateWebcomponentVersionUseCase.WebcomponentVersionCreateRequest request) {
	...
	public WebcomponentVersionRest replaceVersion(@PathVariable String uuid, @PathVariable String versionTag, @RequestBody @Valid ReplaceWebcomponentVersionUseCase.WebcomponentVersionReplaceRequest request) {
